...
either putting it into the subset or not. So all subsets for this no-duplicate set can be easily constructed: num of subset
...
you can either NOT put it into the subset, or put ONE 5 into the subset, 
